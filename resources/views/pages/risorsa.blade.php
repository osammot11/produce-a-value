        ...
        <section class="section section-hero">
            <div class="shell split">
                <div class="panel-dark panel-dark-large sticky-panel">
                    <p class="kicker kicker-large">Risorsa gratuita</p>
                    <h1 class="heading-hero">Checklist per capire perché il tuo sito non converte.</h1>
                ...
                <form class="form-panel form-stack" action="{{ route('risorsa.store') }}" method="post">
                    @csrf
                    ...
                    <button class="button fullwidth" type="submit">Scarica risorsa</button>
                    <a href="{{ route('audit') }}" class="link-button centered-link">Vuoi saltare la checklist? Richiedi audit.</a>
                </form>
            </div>
        </section>
    </main>
